...
def test_http_server_runner_imports():
    ...
    from {{ cookiecutter.project_slug }}.adapters.server_runner import main
...
def test_cli_entry_point_imports():
    ...
    from {{ cookiecutter.project_slug }}.adapters.cli.app import app
...
def test_soap_entry_point_imports():
    ...
    from {{ cookiecutter.project_slug }}.adapters.soap.app import app
...
def test_portal_entry_point_imports():
    ...
    pytest.importorskip("fastapi")
    from {{ cookiecutter.project_slug }}.adapters.portal.app import create_portal_app
...
def test_web_entry_point_imports():
    ...
    pytest.importorskip("fastapi")
    from {{ cookiecutter.project_slug }}.adapters.web.app import create_web_app
...
def test_desktop_entry_point_imports_without_opening_a_window():
    ...
    from {{ cookiecutter.project_slug }}.adapters.desktop.view_model import (
        build_view_model,
    )
...
def test_plugin_entry_point_imports():
    ...
    from {{ cookiecutter.project_slug }}.adapters.plugin.registry import get_plugin
...
def test_suite_entry_point_imports():
    ...
    from {{ cookiecutter.project_slug }}.adapters.suite.runner import run_suite_command
...
def test_ontology_entry_point_imports():
    ...
    from {{ cookiecutter.project_slug }}.ontology.metadata import ontology_document
